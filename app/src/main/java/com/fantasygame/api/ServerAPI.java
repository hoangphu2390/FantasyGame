...
public interface ServerAPI {
    ...
    Observable<FinishTeamResponse> betGameTeams(@Field("game_id") String firstname,
                                                @Field("tie_breaker") String lastname,
                                                @Field("selected_teams[0]") String selected_team_one,
