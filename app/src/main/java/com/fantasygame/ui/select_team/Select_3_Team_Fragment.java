...
public class Select_3_Team_Fragment extends BaseFragment implements SelectTeamView {
    ...
    Team team_one = null, team_two = null, team_three = null;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_select_3_team;
    }
    ...
    public void showResultGetTeamSelect(@NonNull SelectTeamResponse response) {
        if (!response.result || response.data == null || response.data.size() != 3) return;
