...
public class Select_5_Team_Fragment extends BaseFragment implements SelectTeamView {
    ...
    @Bind(R.id.spn_option_5)
    Spinner spn_option_5;
    @Bind(R.id.progressBar)
    ProgressBar progressBar;

    List<Team> selected_teams, option_two_teams, option_three_teams, option_one_teams,
            option_four_teams, option_five_teams;
    Team team_one = null, team_two = null, team_three = null, team_four = null, team_five = null;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_select_5_team;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        spn_option_5.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                team_five = option_five_teams.get(position);
            }
    ...
    public void clickContinue() {
        ...
        if (team_five == null) {
            Utils.showToast("Please select team in option number 5");
            return;
        }
    ...
    private void setupAdapter(Spinner spinner, List<SelectTeamResponse.Team> teams_option) {
    ...
    public void showResultGetTeamSelect(@NonNull SelectTeamResponse response) {
        if (!response.result || response.data == null || response.data.size() != 5) return;
        ...
        option_five_teams = response.data.get(4).teams;
        ...
        setupAdapter(spn_option_5, option_five_teams);
    }
}
